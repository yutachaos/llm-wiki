...
wiki 全ページのカタログ。各ページは「リンク — 一行要約」の形式で載せる。
...
- [暗黙知と形式知](topics/tacit-explicit-knowledge.md) — ポランニーの暗黙知概念と、野中による経営学への展開。知識創造の源泉は両者の変換運動
...
- [The New New Product Development Game](topics/new-new-product-development-game.md) — スクラムの源流となった竹内・野中の HBR 論文（1986）。ラグビー方式の製品開発
- [スクラム](topics/scrum.md) — 経験主義（透明性・検査・適応）に基づく軽量フレームワーク
